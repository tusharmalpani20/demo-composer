...
export class NotAuthorizedError extends CustomError {
  code = general_error_message.unauthorized_error.code;
  type = general_error_message.unauthorized_error.type;
  message = response_message.enum.error;
  result: Api_Error_Response_Type[] = [
    {
      message: general_error_message.unauthorized_error.message,
      type: general_error_message.unauthorized_error.type,
      field: "",
    },
  ];
