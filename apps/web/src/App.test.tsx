...
describe("App", () => {
  ...
  it("renders interactive demo editor routes", async () => {
    ...
    vi.stubGlobal(
      ...
      vi.fn(async (input: RequestInfo | URL) => {
        ...
        if (
          url.endsWith(
            "/api/v1/projects/project_1/interactive-demos/interactive_demo_1",
          )
        ) {
          return jsonResponse({
            interactive_demo: {
        ...
        if (
          url.endsWith(
            "/api/v1/projects/project_1/interactive-demos/interactive_demo_1/scenes",
          )
        ) {
          return jsonResponse({
            demo_scenes: [],
  ...
  it("renders public guide reader routes without portal navigation", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/v1/public/publish-links/abc123", {
      credentials: "include",
      headers: {
