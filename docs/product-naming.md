...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Demo Composer | Descriptive of the alpha but too narrow for Documentation and Video                                                                                                                                                                                                                  | Existing GitHub slug is retained; the unowned npm name `demo-composer` currently resolves to an unrelated `0.1.1` package                       | Existing repository links work                                                                                                        | Low migration cost, weak umbrella                                        |
...
Layer 1 is applied by child plan `110`. Layers 2 through 5 are deliberately
retained and inventoried in `docs/rename-compatibility-checklist.md`.

The current repository directory is therefore still
`/home/tm/Desktop/work/demo_composer_v2`. The current GitHub repository slug,
package names, environment variables, cookie/header/message strings, service
identifiers, storage paths, API routes, database objects, and migration history
remain compatibility identifiers rather than user-facing brand claims.
