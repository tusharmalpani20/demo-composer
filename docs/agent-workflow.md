...
package and network metadata are recorded separately where they exist. The table
records the accepted disposition; confirm the corresponding repository directory
before treating a third-party skill as installed.

| Skill                  | Source and upstream path                                                                                    | Exact source                                                                                                                                                                                            | License                                                                                  | Install disposition                                                                                                                                                                            |
| ---------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| `review-animations`    | Same repository, `skills/review-animations`                                                                 | same commit                                                                                                                                                                                             | MIT, Copyright 2026 Emil Kowalski                                                        | Installed with its `STANDARDS.md`.                                                                                                                                                             |
